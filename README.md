...
npm test         # types, README figures, and <!--p:portfolio.parDepot.economics-->109<!--/p--> tests
```
...
|---|---|---|---|---|---|---|---|---|---|---|---|
| 0.80 | 62 | 37 | 1 | n/a | $496,000 | 62 | 392 | n/a | 0 % | 0.0 d | **holds** |
| 0.70 | 145 | 99 | 1 | n/a | $496,000 | 145 | 309 | free | 1 % | 0.0 d | **holds** |
| 0.60 | 367 | 293 | 1 | n/a | $496,000 | 263 | 191 | free | 3 % | 0.0 d | **holds** |
| **0.50** | **4,154** | **3,444** | **3** | n/a | **$496,000** | **368** | 86 | free | 33 % | 0.1 d | **holds** |
| 0.45 | 13,167 | 10,317 | 8 | n/a | $496,000 | 411 | 43 | free | 98 % | 5.5 d | **late** |
| 0.40 | 32,972 | 24,263 | 19 | 11 | $1,178,000 | 432 | 22 | $32,476 | 230 % | n/a | **breaks** |
| 0.35 | 68,724 | 47,342 | 36 | 28 | $2,232,000 | 445 | 9 | $81,077 | 448 % | n/a | **breaks** |
<!-- /figures:curve -->
...
|---|---|---|---|---|---|---|
| n/a (today) | n/a | 0.50 | 368 | 81 % | $496,000 | n/a |
...
| [31 CFR 1020.320(e)](https://www.law.cornell.edu/cfr/text/31/1020.320) | Nobody at the bank may disclose a report, or any information that would reveal one exists. | n/a | 2026-08-17 |
...
Node 26 with native TypeScript, `node:test`, no build step, no dependencies. <!--p:portfolio.parDepot.economics-->109<!--/p--> tests,
