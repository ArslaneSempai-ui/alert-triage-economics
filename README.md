...
npm test         # types, README figures, and <!--p:portfolio.parDepot.economics-->63<!--/p--> tests
```
...
Node 26 with native TypeScript, `node:test`, no build step, no dependencies. <!--p:portfolio.parDepot.economics-->63<!--/p--> tests,
